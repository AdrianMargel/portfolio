	...
	constructor(){
		...
		this.define(html`
			...
			${new Surface(html`
				...
				<p>
					While ray tracing through this space if the ray ever hits a triangle side with the same rotation as the initial rotation it started at then that becomes a candidate for a periodic path. We can efficiently keep track of this without worry of floating point inaccuracies by counting the number of rotations and reflected rotations of the same angle, if they ever become equal then we are back at the initial rotation.</p>
				<p>
